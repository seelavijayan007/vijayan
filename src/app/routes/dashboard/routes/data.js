...
export const expanseData = [
    {name: 'Jan', Registered: 10, Active: 22},
    {name: 'Feb', Registered: 5, Active: 20},
    {name: 'March', Registered: 15, Active: 26},
    {name: 'April', Registered: 13, Active: 22},
    {name: 'May', Registered: 35, Active: 26},
    {name: 'June', Registered: 25, Active: 20},
    {name: 'July', Registered: 20, Active: 32},
    {name: 'Aug', Registered: 25, Active: 35},
];

export const expanseData1 = [
    {name: 'Jan', Registered: 32, Active: 3},
    {name: 'Feb', Registered: 5, Active: 74},
    {name: 'March', Registered: 100, Active: 2},
    {name: 'April', Registered: 3, Active: 56},
    {name: 'May', Registered: 126, Active: 15},
    {name: 'June', Registered: 16, Active: 80},
    {name: 'July', Registered: 140, Active: 2},
    {name: 'Aug', Registered: 12, Active: 135},
    {name: 'Sep', Registered: 95, Active: 5},
    {name: 'Oct', Registered: 5, Active: 80},
    {name: 'Nov', Registered: 126, Active: 20},
];
