                            ...
                            <div className="col-xl-5 col-lg-6 col-sm-5 col-12">
                                <ChartCard styleName="bg-primary jr-chart-or text-white">
                                    <div className="chart-title text-right">
                                        <h3 className="mb-0">
                                            <IntlMessages id="dashboard.verified"/>
                                            <small>(293)</small>
                                        </h3>
                                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                        <div className="jr-card">
                            ...
                            <CardHeader heading="New Applications"
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        <ChartCard styleName="bg-primary text-white">
                            <div className="chart-title">
                                <h3>800</h3>
                                <p><IntlMessages id="dashboard.approvedApplications"/></p>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        <ChartCard styleName="bg-blue text-white">
                            <div className="chart-title">
                                <h3>200</h3>
                                <p><IntlMessages id="dashboard.rejectedApplications"/></p>
                            </div>
                    ...
                    <div className="col-lg-4 col-sm-6 col-12">
                        <div className="jr-card">
                            <div className="jr-card-header mb-3 d-flex">
                                <h3 className="mb-0 mr-auto"><IntlMessages id="dashboard.currentApplications"/></h3>
